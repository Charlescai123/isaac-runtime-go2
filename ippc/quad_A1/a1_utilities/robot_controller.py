...
import time
import numpy as np
from quad_A1.a1_utilities.a1_sensor_process import observation_to_joint_state

from quad_A1.robot_interface import RobotInterface
...
class RobotController(object):
    def __init__(
        ...
        if self.use_high_level_command:
            self.robot_interface = RobotInterface(0x00)
        else:
            self.robot_interface = RobotInterface(0xff)
