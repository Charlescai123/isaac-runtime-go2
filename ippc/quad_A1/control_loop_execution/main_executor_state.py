...
from quad_A1.a1_utilities.predefined_pose import move_to_sit, move_to_stand
...
class Executor:
    ...
    def warmup_observations(self):
        ...
        print("Policy thread initialization done!")
            ...
            #
            #
            # self.policy.velocity_estimator.update(observation, )
            # estimated_velocity =
            # velocity_hist_normalized = self.policy.velocity_historical_data.record_and_normalize(estimated_velocity)
            #
        ...
        #         self.robot_controller.get_observation(),  self.last_action)  # force frame update
    ...
    def main_execution(self):
        ...
        while self.continue_thread:
            ...
            action = self.policy.get_action(
                robot_observation, self.last_action
            )
            self.last_action = action
