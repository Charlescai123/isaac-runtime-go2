...
from quad_gym.wrapper import utils as env_utils


class ObservationDictionaryToArrayWrapper(gymnasium.Env):
    """An env wrapper that flattens the observation dictionary to an array."""
    ...
    def reset(self, seed=None, options=None):
        ...
        observation, reset_info = self._gym_env.reset()
        return self._flatten_observation(observation), reset_info
    ...
    """
        observation_dict, reward, terminated, truncated, info = self._gym_env.step(action)
        return self._flatten_observation(observation_dict), reward, terminated, truncated, info
